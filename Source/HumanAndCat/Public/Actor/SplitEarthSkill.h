...
#include "SplitEarthSkill.generated.h"

UCLASS()
class HUMANANDCAT_API ASplitEarthSkill : public ASkillActor
{
	GENERATED_BODY()
...
public:
	...
	void LaunchSplitEarth(const FVector& CenterDirection, const FVector& Direction);
